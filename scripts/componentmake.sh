...
#!/bin/bash
if [ -z $1 ] || [ -z $2 ]; then
    echo "newcomponent requires 2 arguments: newcomponent NAMESPACE COMPONENTNAME"
  ...
  echo "Source files for $2 already exists!"
    ...
    headerTemplateData=`cat newcomponent_templates/headertemplate`
    ...
    cppTemplateData=`cat newcomponent_templates/cpptemplate`
